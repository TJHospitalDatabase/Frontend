...
export default {
    ...
    computed:{
        checkresultlist_current:function(){
            return this.checkresultlist.slice((this.r_queryInfo.PAGE_NUM-1)*this.r_queryInfo.PAGE_SIZE,
            Math.min(this.r_queryInfo.PAGE_NUM*this.r_queryInfo.PAGE_SIZE,this.checkresultlist.length));
        },
        datalist_current:function(){
            return this.datalist.slice((this.s_queryInfo.PAGE_NUM-1)*this.s_queryInfo.PAGE_SIZE,
            Math.min(this.s_queryInfo.PAGE_NUM*this.s_queryInfo.PAGE_SIZE,this.datalist.length));
        }
    },
